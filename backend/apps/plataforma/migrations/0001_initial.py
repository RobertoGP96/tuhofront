    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen_cabecera', models.ImageField(blank=True, null=True, upload_to='Noticias/24-06-2024/', validators=[backend.apps.plataforma.models.models.validate_file_extension])),
