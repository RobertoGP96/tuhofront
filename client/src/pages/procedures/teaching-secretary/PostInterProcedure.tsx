...
import { CloudUpload, Globe, GraduationCap, User, Loader2, FileText } from "lucide-react";
...
export const PostInterProcedure = () => {
  ...
  const [formData, setFormData] = useState<Partial<SecretaryDocProcedureForm>>({
    ...
    email: user?.email || '',
    document_type: 'CERTIFICACION_POSTGRADO',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Su solicitud de postgrado internacional ha sido enviada exitosamente.",
      });
