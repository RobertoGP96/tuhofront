...
export const PostInterProcedure = () => {
    return <div className="w-full flex flex-col gap-2">
        <h3 className="uppercase mb-3 font-bold text-primary text-xl">Datos de Solicitud - Título Internacional de Postgrado</h3>
        <div className="w-full flex flex-row gap-2 flex-nowrap">
            ...
            <div className="flex flex-col gap-2 w-1/3">
                ...
                <InputText id="tipoUso" disabled value={"Internacional"} />
            </div>
            <div className="flex flex-col gap-2 w-1/3">
